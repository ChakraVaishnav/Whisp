export const metadata = {
  ...
  description: "Read Whisp's privacy policy to learn how your data is protected and managed.",
  keywords: [
    "privacy policy",
    "Whisp privacy",
    "data protection",
  ...
  openGraph: {
    title: "Privacy Policy | Whisp",
    description: "Read Whisp's privacy policy to learn how your data is protected and managed.",
    url: "https://whispchat.vercel.app/privacy",
    siteName: "Whisp",
    type: "article",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Whisp privacy policy screenshot",
      },
    ],
  },
  robots: {
