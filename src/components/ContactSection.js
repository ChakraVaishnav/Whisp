    ...
    >
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-bold">Let’s build securely together</h2>
          <p className="text-gray-300 max-w-3xl mx-auto">
            Send ideas, questions, or deployment details directly to the Whisp team. We monitor conversations around encryption, presence, and high-speed messaging daily.
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Send ideas, bug reports, or deployment requests directly to the Whisp inbox. We answer every message in one business day.
          </p>
          <Link
            href={`mailto:${EMAIL}`}
